...
<?php } ?>
    ...
    <a style="text-decoration: none;" onclick="ym(77765119, 'reachGoal', 'click_cart_checkout'); fbq('track', 'InitiateCheckout'); return true;" class="cart-button-desktop animated-background"
        <?php
